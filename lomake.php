...
include("yesno.php");
	...
	print "<td class=\"solu ke\"><input type=\"radio\" value=\"kyllä\" name=\"kys80\"></td><td class=\"solu ke\"><input type=\"radio\" name=\"kys80\" value=\"ei\"></td></tr>";
print "</table><p><span class=\"kaannos\">" . $kysymys81[$kieli] . "</span><br><span class=\"suomi\">"
. $kysymys81[0] . "</span><p>";
print "<input type=\"text\" class=\"textfield\" name=\"kys81\">";
print "</div>";

// Allergiat
print "<div class=\"kysymyslohko\">";
print "<span class=\"kaannos\">" . $kysymys82[$kieli] . "</span>";
print "<br><span class=\"suomi\">" . $kysymys82[0] . "</span><br>";
print "<table class=\"osa\">";
